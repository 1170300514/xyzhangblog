---
title: RestfulAPI最佳实践
date: 2020-12-31 20:41:00
tags: 
    - Restful API
    - Web
summary: 在前后端分离架构中后端只需要提供API接口返回数据，API接口通常需要遵循Restful风格
---

[转载] 原创出处 http://www.ruanyifeng.com/blog/2018/10/restful-api-best-practices.html 「阮一峰」
